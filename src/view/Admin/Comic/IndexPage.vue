<template>
  ...
  >
    <h1 class="h2">Dashboard Comic Admin</h1>
  </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card border-0 rounded shadow">
          <div class="card-body">
            <router-link
              :to="{ name: 'comicAdmin.create' }"
              class="btn btn-md btn-success"
              style="float: left; margin: 10px"
              >TAMBAH COMIC</router-link
            >
            <table class="table table-striped table-bordered mt-4">
              ...
              <tbody>
                <tr v-for="(comic, id) in comics" :key="id">
                  ...
                  <td>
                    <img
                      :src="require(`/image/${comic.gambar}`)"
                      width="80"
                      height="90"
                    />
                  </td>
                  <td>
                    ...
                    >
                    <button
                      @click.prevent="comicDelete(comic.id)"
